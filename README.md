...
Вот так это выглядит: Android приложение отправляет данные через ZMQ на Python сервер, сервер сохраняет в PostgreSQL, а graph.py читает и показывает график.

Нужно нарисовать схему в Draw.io или Visio, сохранить как изображение (например, architecture.png или architecture.jpg) в папку проекта, и добавить сюда так:

![Схема архитектуры](images.png)
